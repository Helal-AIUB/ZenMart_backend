    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('PAYMENT_STATUS_PENDING', 'Pending'), ('PAYMENT_STATUS_COMPLETE', 'Complete'), ('PAYMENT_STATUS_FAILED', 'Failed')], default='P', max_length=30)),
